...
libmain(int argc, char **argv)
{
  ...
  80006c:	ba 7c 00 c0 ee       	mov    $0xeec0007c,%edx
  800071:	eb 12                	jmp    800085 <libmain+0x41>
  800073:	8b 4a 48             	mov    0x48(%edx),%ecx
  800076:	83 c2 7c             	add    $0x7c,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  80015e:	00 
  80015f:	c7 44 24 08 ca 12 80 	movl   $0x8012ca,0x8(%esp)
  800166:	00 
  800167:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80016e:	00 
  80016f:	c7 04 24 e7 12 80 00 	movl   $0x8012e7,(%esp)
  800176:	e8 d5 02 00 00       	call   800450 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80021d:	00 
  80021e:	c7 44 24 08 ca 12 80 	movl   $0x8012ca,0x8(%esp)
  800225:	00 
  800226:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80022d:	00 
  80022e:	c7 04 24 e7 12 80 00 	movl   $0x8012e7,(%esp)
  800235:	e8 16 02 00 00       	call   800450 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80027b:	00 
  80027c:	c7 44 24 08 ca 12 80 	movl   $0x8012ca,0x8(%esp)
  800283:	00 
  800284:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80028b:	00 
  80028c:	c7 04 24 e7 12 80 00 	movl   $0x8012e7,(%esp)
  800293:	e8 b8 01 00 00       	call   800450 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002d9:	00 
  8002da:	c7 44 24 08 ca 12 80 	movl   $0x8012ca,0x8(%esp)
  8002e1:	00 
  8002e2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002e9:	00 
  8002ea:	c7 04 24 e7 12 80 00 	movl   $0x8012e7,(%esp)
  8002f1:	e8 5a 01 00 00       	call   800450 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800337:	00 
  800338:	c7 44 24 08 ca 12 80 	movl   $0x8012ca,0x8(%esp)
  80033f:	00 
  800340:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800347:	00 
  800348:	c7 04 24 e7 12 80 00 	movl   $0x8012e7,(%esp)
  80034f:	e8 fc 00 00 00       	call   800450 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800395:	00 
  800396:	c7 44 24 08 ca 12 80 	movl   $0x8012ca,0x8(%esp)
  80039d:	00 
  80039e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003a5:	00 
  8003a6:	c7 04 24 e7 12 80 00 	movl   $0x8012e7,(%esp)
  8003ad:	e8 9e 00 00 00       	call   800450 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800426:	00 
  800427:	c7 44 24 08 ca 12 80 	movl   $0x8012ca,0x8(%esp)
  80042e:	00 
  80042f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800436:	00 
  800437:	c7 04 24 e7 12 80 00 	movl   $0x8012e7,(%esp)
  80043e:	e8 0d 00 00 00       	call   800450 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800458:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	if (argv0)
  80045b:	a1 08 20 80 00       	mov    0x802008,%eax
  800460:	85 c0                	test   %eax,%eax
  800462:	74 10                	je     800474 <_panic+0x24>
		cprintf("%s: ", argv0);
  800464:	89 44 24 04          	mov    %eax,0x4(%esp)
  800468:	c7 04 24 f5 12 80 00 	movl   $0x8012f5,(%esp)
  80046f:	e8 ef 00 00 00       	call   800563 <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800474:	8b 35 00 20 80 00    	mov    0x802000,%esi
  80047a:	e8 09 fd ff ff       	call   800188 <sys_getenvid>
  ...
  80048d:	89 74 24 08          	mov    %esi,0x8(%esp)
  800491:	89 44 24 04          	mov    %eax,0x4(%esp)
  800495:	c7 04 24 fc 12 80 00 	movl   $0x8012fc,(%esp)
  80049c:	e8 c2 00 00 00       	call   800563 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8004a1:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8004a5:	8b 45 10             	mov    0x10(%ebp),%eax
  8004a8:	89 04 24             	mov    %eax,(%esp)
  8004ab:	e8 52 00 00 00       	call   800502 <vcprintf>
	cprintf("\n");
  8004b0:	c7 04 24 fa 12 80 00 	movl   $0x8012fa,(%esp)
  8004b7:	e8 a7 00 00 00       	call   800563 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8004bc:	cc                   	int3   
  8004bd:	eb fd                	jmp    8004bc <_panic+0x6c>
  8004bf:	90                   	nop
...
putch(int ch, struct printbuf *b)
{
  ...
  8004ed:	e8 da fb ff ff       	call   8000cc <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80053e:	e8 af 01 00 00       	call   8006f2 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800556:	e8 71 fb ff ff       	call   8000cc <sys_cputs>
