...
umain(int argc, char **argv)
{
  ...
  80003a:	c7 04 24 d0 10 80 00 	movl   $0x8010d0,(%esp)
...
umain(int argc, char **argv)
{
  ...
  800069:	c7 44 24 08 4b 11 80 	movl   $0x80114b,0x8(%esp)
  800070:	00 
  800071:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  800078:	00 
  800079:	c7 04 24 68 11 80 00 	movl   $0x801168,(%esp)
...
umain(int argc, char **argv)
{
  ...
  8000c7:	c7 44 24 08 f0 10 80 	movl   $0x8010f0,0x8(%esp)
  8000ce:	00 
  8000cf:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  8000d6:	00 
  8000d7:	c7 04 24 68 11 80 00 	movl   $0x801168,(%esp)
  ...
  800103:	c7 44 24 08 77 11 80 	movl   $0x801177,0x8(%esp)
  80010a:	00 
  80010b:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800112:	00 
  800113:	c7 04 24 68 11 80 00 	movl   $0x801168,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001b1:	c7 04 24 a0 11 80 00 	movl   $0x8011a0,(%esp)
  ...
  8001c7:	e8 52 00 00 00       	call   80021e <vcprintf>
	cprintf("\n");
  8001cc:	c7 04 24 66 11 80 00 	movl   $0x801166,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800315:	e8 d6 0a 00 00       	call   800df0 <__udivdi3>
  ...
  800373:	e8 c8 0b 00 00       	call   800f40 <__umoddi3>
  800378:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80037c:	0f be 80 c4 11 80 00 	movsbl 0x8011c4(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004a7:	ff 24 85 54 12 80 00 	jmp    *0x801254(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800598:	c7 44 24 08 e5 11 80 	movl   $0x8011e5,0x8(%esp)
  80059f:	00 
  ...
  8005ca:	b8 d5 11 80 00       	mov    $0x8011d5,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800d92:	00 
  800d93:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800d9a:	00 
  800d9b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800da2:	00 
  800da3:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
...
00800df0 <__udivdi3>:
  ...
  800df3:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  800df7:	89 7c 24 14          	mov    %edi,0x14(%esp)
  800dfb:	8b 4c 24 28          	mov    0x28(%esp),%ecx
  800dff:	89 6c 24 18          	mov    %ebp,0x18(%esp)
  800e03:	8b 7c 24 20          	mov    0x20(%esp),%edi
  800e07:	8b 6c 24 24          	mov    0x24(%esp),%ebp
  800e0b:	85 c0                	test   %eax,%eax
  800e0d:	89 74 24 10          	mov    %esi,0x10(%esp)
  800e11:	89 7c 24 08          	mov    %edi,0x8(%esp)
  800e15:	89 ea                	mov    %ebp,%edx
  800e17:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  800e1b:	75 33                	jne    800e50 <__udivdi3+0x60>
  800e1d:	39 e9                	cmp    %ebp,%ecx
  800e1f:	77 6f                	ja     800e90 <__udivdi3+0xa0>
  800e21:	85 c9                	test   %ecx,%ecx
  800e23:	89 ce                	mov    %ecx,%esi
  800e25:	75 0b                	jne    800e32 <__udivdi3+0x42>
  ...
  800e34:	89 e8                	mov    %ebp,%eax
  800e36:	f7 f6                	div    %esi
  800e38:	89 c5                	mov    %eax,%ebp
  800e3a:	89 f8                	mov    %edi,%eax
  800e3c:	f7 f6                	div    %esi
  800e3e:	89 ea                	mov    %ebp,%edx
  ...
  800e52:	77 24                	ja     800e78 <__udivdi3+0x88>
  800e54:	0f bd c8             	bsr    %eax,%ecx
  800e57:	83 f1 1f             	xor    $0x1f,%ecx
  800e5a:	89 0c 24             	mov    %ecx,(%esp)
  800e5d:	75 49                	jne    800ea8 <__udivdi3+0xb8>
  800e5f:	8b 74 24 08          	mov    0x8(%esp),%esi
  800e63:	39 74 24 04          	cmp    %esi,0x4(%esp)
  800e67:	0f 86 ab 00 00 00    	jbe    800f18 <__udivdi3+0x128>
  800e6d:	39 e8                	cmp    %ebp,%eax
  800e6f:	0f 82 a3 00 00 00    	jb     800f18 <__udivdi3+0x128>
  800e75:	8d 76 00             	lea    0x0(%esi),%esi
  800e78:	31 d2                	xor    %edx,%edx
  800e7a:	31 c0                	xor    %eax,%eax
  800e7c:	8b 74 24 10          	mov    0x10(%esp),%esi
  800e80:	8b 7c 24 14          	mov    0x14(%esp),%edi
  800e84:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  800e88:	83 c4 1c             	add    $0x1c,%esp
  800e8b:	c3                   	ret    
  800e8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  800e90:	89 f8                	mov    %edi,%eax
  800e92:	f7 f1                	div    %ecx
  800e94:	31 d2                	xor    %edx,%edx
  800e96:	8b 74 24 10          	mov    0x10(%esp),%esi
  800e9a:	8b 7c 24 14          	mov    0x14(%esp),%edi
  800e9e:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  800ea2:	83 c4 1c             	add    $0x1c,%esp
  800ea5:	c3                   	ret    
  800ea6:	66 90                	xchg   %ax,%ax
  800ea8:	0f b6 0c 24          	movzbl (%esp),%ecx
  800eac:	89 c6                	mov    %eax,%esi
  800eae:	b8 20 00 00 00       	mov    $0x20,%eax
  800eb3:	8b 6c 24 04          	mov    0x4(%esp),%ebp
  800eb7:	2b 04 24             	sub    (%esp),%eax
  800eba:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800ebe:	d3 e6                	shl    %cl,%esi
  800ec0:	89 c1                	mov    %eax,%ecx
  800ec2:	d3 ed                	shr    %cl,%ebp
  800ec4:	0f b6 0c 24          	movzbl (%esp),%ecx
  800ec8:	09 f5                	or     %esi,%ebp
  800eca:	8b 74 24 04          	mov    0x4(%esp),%esi
  800ece:	d3 e6                	shl    %cl,%esi
  800ed0:	89 c1                	mov    %eax,%ecx
  800ed2:	89 74 24 04          	mov    %esi,0x4(%esp)
  800ed6:	89 d6                	mov    %edx,%esi
  800ed8:	d3 ee                	shr    %cl,%esi
  800eda:	0f b6 0c 24          	movzbl (%esp),%ecx
  800ede:	d3 e2                	shl    %cl,%edx
  800ee0:	89 c1                	mov    %eax,%ecx
  800ee2:	d3 ef                	shr    %cl,%edi
  800ee4:	09 d7                	or     %edx,%edi
  800ee6:	89 f2                	mov    %esi,%edx
  800ee8:	89 f8                	mov    %edi,%eax
  800eea:	f7 f5                	div    %ebp
  800eec:	89 d6                	mov    %edx,%esi
  800eee:	89 c7                	mov    %eax,%edi
  800ef0:	f7 64 24 04          	mull   0x4(%esp)
  800ef4:	39 d6                	cmp    %edx,%esi
  800ef6:	72 30                	jb     800f28 <__udivdi3+0x138>
  800ef8:	8b 6c 24 08          	mov    0x8(%esp),%ebp
  800efc:	0f b6 0c 24          	movzbl (%esp),%ecx
  800f00:	d3 e5                	shl    %cl,%ebp
  800f02:	39 c5                	cmp    %eax,%ebp
  800f04:	73 04                	jae    800f0a <__udivdi3+0x11a>
  800f06:	39 d6                	cmp    %edx,%esi
  800f08:	74 1e                	je     800f28 <__udivdi3+0x138>
  800f0a:	89 f8                	mov    %edi,%eax
  800f0c:	31 d2                	xor    %edx,%edx
  800f0e:	e9 69 ff ff ff       	jmp    800e7c <__udivdi3+0x8c>
  800f13:	90                   	nop
  800f14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  800f18:	31 d2                	xor    %edx,%edx
  800f1a:	b8 01 00 00 00       	mov    $0x1,%eax
  800f1f:	e9 58 ff ff ff       	jmp    800e7c <__udivdi3+0x8c>
  800f24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  800f28:	8d 47 ff             	lea    -0x1(%edi),%eax
  800f2b:	31 d2                	xor    %edx,%edx
  800f2d:	8b 74 24 10          	mov    0x10(%esp),%esi
  800f31:	8b 7c 24 14          	mov    0x14(%esp),%edi
  800f35:	8b 6c 24 18          	mov    0x18(%esp),%ebp
...
00800f40 <__umoddi3>:
  ...
  800f43:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  800f47:	8b 4c 24 30          	mov    0x30(%esp),%ecx
  800f4b:	89 74 24 20          	mov    %esi,0x20(%esp)
  800f4f:	8b 74 24 38          	mov    0x38(%esp),%esi
  800f53:	89 7c 24 24          	mov    %edi,0x24(%esp)
  800f57:	8b 7c 24 34          	mov    0x34(%esp),%edi
  800f5b:	85 c0                	test   %eax,%eax
  800f5d:	89 c2                	mov    %eax,%edx
  800f5f:	89 6c 24 28          	mov    %ebp,0x28(%esp)
  800f63:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
  800f67:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  800f6b:	89 74 24 10          	mov    %esi,0x10(%esp)
  800f6f:	89 4c 24 14          	mov    %ecx,0x14(%esp)
  800f73:	89 7c 24 18          	mov    %edi,0x18(%esp)
  800f77:	75 1f                	jne    800f98 <__umoddi3+0x58>
  800f79:	39 fe                	cmp    %edi,%esi
  800f7b:	76 63                	jbe    800fe0 <__umoddi3+0xa0>
  800f7d:	89 c8                	mov    %ecx,%eax
  800f7f:	89 fa                	mov    %edi,%edx
  800f81:	f7 f6                	div    %esi
  800f83:	89 d0                	mov    %edx,%eax
  800f85:	31 d2                	xor    %edx,%edx
  800f87:	8b 74 24 20          	mov    0x20(%esp),%esi
  800f8b:	8b 7c 24 24          	mov    0x24(%esp),%edi
  800f8f:	8b 6c 24 28          	mov    0x28(%esp),%ebp
  800f93:	83 c4 2c             	add    $0x2c,%esp
  800f96:	c3                   	ret    
  800f97:	90                   	nop
  800f98:	39 f8                	cmp    %edi,%eax
  800f9a:	77 64                	ja     801000 <__umoddi3+0xc0>
  800f9c:	0f bd e8             	bsr    %eax,%ebp
  800f9f:	83 f5 1f             	xor    $0x1f,%ebp
  800fa2:	75 74                	jne    801018 <__umoddi3+0xd8>
  800fa4:	8b 7c 24 14          	mov    0x14(%esp),%edi
  800fa8:	39 7c 24 10          	cmp    %edi,0x10(%esp)
  800fac:	0f 87 0e 01 00 00    	ja     8010c0 <__umoddi3+0x180>
  800fb2:	8b 7c 24 0c          	mov    0xc(%esp),%edi
  800fb6:	29 f1                	sub    %esi,%ecx
  800fb8:	19 c7                	sbb    %eax,%edi
  800fba:	89 4c 24 14          	mov    %ecx,0x14(%esp)
  800fbe:	89 7c 24 18          	mov    %edi,0x18(%esp)
  800fc2:	8b 44 24 14          	mov    0x14(%esp),%eax
  800fc6:	8b 54 24 18          	mov    0x18(%esp),%edx
  800fca:	8b 74 24 20          	mov    0x20(%esp),%esi
  800fce:	8b 7c 24 24          	mov    0x24(%esp),%edi
  800fd2:	8b 6c 24 28          	mov    0x28(%esp),%ebp
  800fd6:	83 c4 2c             	add    $0x2c,%esp
  800fd9:	c3                   	ret    
  800fda:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  800fe0:	85 f6                	test   %esi,%esi
  800fe2:	89 f5                	mov    %esi,%ebp
  800fe4:	75 0b                	jne    800ff1 <__umoddi3+0xb1>
  800fe6:	b8 01 00 00 00       	mov    $0x1,%eax
  800feb:	31 d2                	xor    %edx,%edx
  800fed:	f7 f6                	div    %esi
  800fef:	89 c5                	mov    %eax,%ebp
  800ff1:	8b 44 24 0c          	mov    0xc(%esp),%eax
  800ff5:	31 d2                	xor    %edx,%edx
  800ff7:	f7 f5                	div    %ebp
  800ff9:	89 c8                	mov    %ecx,%eax
  800ffb:	f7 f5                	div    %ebp
  800ffd:	eb 84                	jmp    800f83 <__umoddi3+0x43>
  800fff:	90                   	nop
  801000:	89 c8                	mov    %ecx,%eax
  801002:	89 fa                	mov    %edi,%edx
  801004:	8b 74 24 20          	mov    0x20(%esp),%esi
  801008:	8b 7c 24 24          	mov    0x24(%esp),%edi
  80100c:	8b 6c 24 28          	mov    0x28(%esp),%ebp
  801010:	83 c4 2c             	add    $0x2c,%esp
  801013:	c3                   	ret    
  801014:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801018:	8b 44 24 10          	mov    0x10(%esp),%eax
  80101c:	be 20 00 00 00       	mov    $0x20,%esi
  801021:	89 e9                	mov    %ebp,%ecx
  801023:	29 ee                	sub    %ebp,%esi
  801025:	d3 e2                	shl    %cl,%edx
  801027:	89 f1                	mov    %esi,%ecx
  801029:	d3 e8                	shr    %cl,%eax
  80102b:	89 e9                	mov    %ebp,%ecx
  80102d:	09 d0                	or     %edx,%eax
  80102f:	89 fa                	mov    %edi,%edx
  801031:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801035:	8b 44 24 10          	mov    0x10(%esp),%eax
  ...
  80104b:	89 f1                	mov    %esi,%ecx
  80104d:	d3 e8                	shr    %cl,%eax
  80104f:	89 e9                	mov    %ebp,%ecx
  801051:	09 f8                	or     %edi,%eax
  801053:	8b 7c 24 1c          	mov    0x1c(%esp),%edi
  801057:	f7 74 24 0c          	divl   0xc(%esp)
  80105b:	d3 e7                	shl    %cl,%edi
  80105d:	89 7c 24 18          	mov    %edi,0x18(%esp)
  801061:	89 d7                	mov    %edx,%edi
  801063:	f7 64 24 10          	mull   0x10(%esp)
  801067:	39 d7                	cmp    %edx,%edi
  801069:	89 c1                	mov    %eax,%ecx
  80106b:	89 54 24 14          	mov    %edx,0x14(%esp)
  80106f:	72 3b                	jb     8010ac <__umoddi3+0x16c>
  801071:	39 44 24 18          	cmp    %eax,0x18(%esp)
  801075:	72 31                	jb     8010a8 <__umoddi3+0x168>
  801077:	8b 44 24 18          	mov    0x18(%esp),%eax
  80107b:	29 c8                	sub    %ecx,%eax
  80107d:	19 d7                	sbb    %edx,%edi
  80107f:	89 e9                	mov    %ebp,%ecx
  801081:	89 fa                	mov    %edi,%edx
  801083:	d3 e8                	shr    %cl,%eax
  801085:	89 f1                	mov    %esi,%ecx
  801087:	d3 e2                	shl    %cl,%edx
  801089:	89 e9                	mov    %ebp,%ecx
  80108b:	09 d0                	or     %edx,%eax
  80108d:	89 fa                	mov    %edi,%edx
  80108f:	d3 ea                	shr    %cl,%edx
  801091:	8b 74 24 20          	mov    0x20(%esp),%esi
  801095:	8b 7c 24 24          	mov    0x24(%esp),%edi
  801099:	8b 6c 24 28          	mov    0x28(%esp),%ebp
  80109d:	83 c4 2c             	add    $0x2c,%esp
  8010a0:	c3                   	ret    
  8010a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  8010a8:	39 d7                	cmp    %edx,%edi
  8010aa:	75 cb                	jne    801077 <__umoddi3+0x137>
  8010ac:	8b 54 24 14          	mov    0x14(%esp),%edx
  8010b0:	89 c1                	mov    %eax,%ecx
  8010b2:	2b 4c 24 10          	sub    0x10(%esp),%ecx
  8010b6:	1b 54 24 0c          	sbb    0xc(%esp),%edx
  8010ba:	eb bb                	jmp    801077 <__umoddi3+0x137>
  8010bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  8010c0:	3b 44 24 18          	cmp    0x18(%esp),%eax
  8010c4:	0f 82 e8 fe ff ff    	jb     800fb2 <__umoddi3+0x72>
  8010ca:	e9 f3 fe ff ff       	jmp    800fc2 <__umoddi3+0x82>
