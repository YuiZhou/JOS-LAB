...
libmain(int argc, char **argv)
{
  ...
  80007c:	ba 60 00 c0 ee       	mov    $0xeec00060,%edx
  800081:	eb 12                	jmp    800095 <libmain+0x41>
  800083:	8b 4a 48             	mov    0x48(%edx),%ecx
  800086:	83 c2 60             	add    $0x60,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  80016e:	00 
  80016f:	c7 44 24 08 58 10 80 	movl   $0x801058,0x8(%esp)
  800176:	00 
  800177:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80017e:	00 
  80017f:	c7 04 24 75 10 80 00 	movl   $0x801075,(%esp)
  800186:	e8 3d 00 00 00       	call   8001c8 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001d0:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	if (argv0)
  8001d3:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8001d8:	85 c0                	test   %eax,%eax
  8001da:	74 10                	je     8001ec <_panic+0x24>
		cprintf("%s: ", argv0);
  8001dc:	89 44 24 04          	mov    %eax,0x4(%esp)
  8001e0:	c7 04 24 83 10 80 00 	movl   $0x801083,(%esp)
  8001e7:	e8 ef 00 00 00       	call   8002db <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8001ec:	8b 35 04 20 80 00    	mov    0x802004,%esi
  8001f2:	e8 a1 ff ff ff       	call   800198 <sys_getenvid>
  ...
  800205:	89 74 24 08          	mov    %esi,0x8(%esp)
  800209:	89 44 24 04          	mov    %eax,0x4(%esp)
  80020d:	c7 04 24 88 10 80 00 	movl   $0x801088,(%esp)
  800214:	e8 c2 00 00 00       	call   8002db <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800219:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  80021d:	8b 45 10             	mov    0x10(%ebp),%eax
  800220:	89 04 24             	mov    %eax,(%esp)
  800223:	e8 52 00 00 00       	call   80027a <vcprintf>
	cprintf("\n");
  800228:	c7 04 24 4c 10 80 00 	movl   $0x80104c,(%esp)
  80022f:	e8 a7 00 00 00       	call   8002db <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800234:	cc                   	int3   
  800235:	eb fd                	jmp    800234 <_panic+0x6c>
  800237:	90                   	nop
...
putch(int ch, struct printbuf *b)
{
  ...
  80024b:	83 c0 01             	add    $0x1,%eax
  80024e:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  800250:	3d ff 00 00 00       	cmp    $0xff,%eax
  800255:	75 19                	jne    800270 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  800257:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  80025e:	00 
  80025f:	8d 43 08             	lea    0x8(%ebx),%eax
  800262:	89 04 24             	mov    %eax,(%esp)
  800265:	e8 72 fe ff ff       	call   8000dc <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80027d:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;

	b.idx = 0;
  800283:	c7 85 f0 fe ff ff 00 	movl   $0x0,-0x110(%ebp)
  80028a:	00 00 00 
	b.cnt = 0;
  80028d:	c7 85 f4 fe ff ff 00 	movl   $0x0,-0x10c(%ebp)
  800294:	00 00 00 
	vprintfmt((void*)putch, &b, fmt, ap);
  800297:	8b 45 0c             	mov    0xc(%ebp),%eax
  80029a:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80029e:	8b 45 08             	mov    0x8(%ebp),%eax
  8002a1:	89 44 24 08          	mov    %eax,0x8(%esp)
  8002a5:	8d 85 f0 fe ff ff    	lea    -0x110(%ebp),%eax
  8002ab:	89 44 24 04          	mov    %eax,0x4(%esp)
  8002af:	c7 04 24 38 02 80 00 	movl   $0x800238,(%esp)
  8002b6:	e8 b7 01 00 00       	call   800472 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  8002bb:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  8002c1:	89 44 24 04          	mov    %eax,0x4(%esp)
  8002c5:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  8002cb:	89 04 24             	mov    %eax,(%esp)
  8002ce:	e8 09 fe ff ff       	call   8000dc <sys_cputs>
...
cprintf(const char *fmt, ...)
{
  ...
  8002ee:	e8 87 ff ff ff       	call   80027a <vcprintf>
	va_end(ap);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8003dc:	0f be 80 ac 10 80 00 	movsbl 0x8010ac(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800507:	ff 24 85 3c 11 80 00 	jmp    *0x80113c(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8005f8:	c7 44 24 08 cd 10 80 	movl   $0x8010cd,0x8(%esp)
  8005ff:	00 
  ...
  80062a:	b8 bd 10 80 00       	mov    $0x8010bd,%eax
