...
sys_env_destroy(envid_t envid)
{
  ...
  800132:	00 
  800133:	c7 44 24 08 18 10 80 	movl   $0x801018,0x8(%esp)
  80013a:	00 
  80013b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800142:	00 
  800143:	c7 04 24 35 10 80 00 	movl   $0x801035,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800194:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	if (argv0)
  800197:	a1 0c 20 80 00       	mov    0x80200c,%eax
  80019c:	85 c0                	test   %eax,%eax
  80019e:	74 10                	je     8001b0 <_panic+0x24>
		cprintf("%s: ", argv0);
  8001a0:	89 44 24 04          	mov    %eax,0x4(%esp)
  8001a4:	c7 04 24 43 10 80 00 	movl   $0x801043,(%esp)
  8001ab:	e8 ef 00 00 00       	call   80029f <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8001b0:	8b 35 04 20 80 00    	mov    0x802004,%esi
  8001b6:	e8 a1 ff ff ff       	call   80015c <sys_getenvid>
  8001bb:	8b 55 0c             	mov    0xc(%ebp),%edx
  8001be:	89 54 24 10          	mov    %edx,0x10(%esp)
  8001c2:	8b 55 08             	mov    0x8(%ebp),%edx
  8001c5:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8001c9:	89 74 24 08          	mov    %esi,0x8(%esp)
  8001cd:	89 44 24 04          	mov    %eax,0x4(%esp)
  8001d1:	c7 04 24 48 10 80 00 	movl   $0x801048,(%esp)
  8001d8:	e8 c2 00 00 00       	call   80029f <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8001dd:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8001e1:	8b 45 10             	mov    0x10(%ebp),%eax
  8001e4:	89 04 24             	mov    %eax,(%esp)
  8001e7:	e8 52 00 00 00       	call   80023e <vcprintf>
	cprintf("\n");
  8001ec:	c7 04 24 0c 10 80 00 	movl   $0x80100c,(%esp)
  8001f3:	e8 a7 00 00 00       	call   80029f <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8001f8:	cc                   	int3   
  8001f9:	eb fd                	jmp    8001f8 <_panic+0x6c>
  8001fb:	90                   	nop
...
putch(int ch, struct printbuf *b)
{
  ...
  800229:	e8 72 fe ff ff       	call   8000a0 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80027a:	e8 b3 01 00 00       	call   800432 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800292:	e8 09 fe ff ff       	call   8000a0 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80039c:	0f be 80 6c 10 80 00 	movsbl 0x80106c(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004c7:	ff 24 85 fc 10 80 00 	jmp    *0x8010fc(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8005b8:	c7 44 24 08 8d 10 80 	movl   $0x80108d,0x8(%esp)
  8005bf:	00 
  ...
  8005ea:	b8 7d 10 80 00       	mov    $0x80107d,%eax
