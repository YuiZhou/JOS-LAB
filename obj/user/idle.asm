...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003a:	c7 05 00 20 80 00 e0 	movl   $0x8012e0,0x802000
  800041:	12 80 00 
	...
	while (1) {
		sys_yield();
  800044:	e8 77 01 00 00       	call   8001c0 <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  80005b:	e8 30 01 00 00       	call   800190 <sys_getenvid>
	thisenv = envs;
  800060:	c7 05 04 20 80 00 00 	movl   $0xeec00000,0x802004
  800067:	00 c0 ee 
	for(;thisenv;thisenv++)
		if(thisenv -> env_id == thisid)
  80006a:	8b 15 48 00 c0 ee    	mov    0xeec00048,%edx
  800070:	39 c2                	cmp    %eax,%edx
  800072:	74 25                	je     800099 <libmain+0x4d>
  800074:	ba 7c 00 c0 ee       	mov    $0xeec0007c,%edx
  800079:	eb 12                	jmp    80008d <libmain+0x41>
  80007b:	8b 4a 48             	mov    0x48(%edx),%ecx
  80007e:	83 c2 7c             	add    $0x7c,%edx
  800081:	39 c1                	cmp    %eax,%ecx
  800083:	75 08                	jne    80008d <libmain+0x41>
  800085:	89 3d 04 20 80 00    	mov    %edi,0x802004
  80008b:	eb 0c                	jmp    800099 <libmain+0x4d>
{
	// set thisenv to point at our Env structure in envs[].
	// LAB 3: Your code here.
	envid_t thisid = sys_getenvid();
  ...
  800091:	75 e8                	jne    80007b <libmain+0x2f>
  800093:	89 15 04 20 80 00    	mov    %edx,0x802004
		if(thisenv -> env_id == thisid)
			break;
  ...
  80009b:	7e 07                	jle    8000a4 <libmain+0x58>
		binaryname = argv[0];
  ...
  80009f:	a3 00 20 80 00       	mov    %eax,0x802000
	...
	umain(argc, argv);
  8000a4:	89 74 24 04          	mov    %esi,0x4(%esp)
  8000a8:	89 1c 24             	mov    %ebx,(%esp)
  8000ab:	e8 84 ff ff ff       	call   800034 <umain>

	// exit gracefully
	exit();
  8000b0:	e8 0b 00 00 00       	call   8000c0 <exit>
}
  8000b5:	83 c4 1c             	add    $0x1c,%esp
  8000b8:	5b                   	pop    %ebx
  8000b9:	5e                   	pop    %esi
  8000ba:	5f                   	pop    %edi
  8000bb:	5d                   	pop    %ebp
...
exit(void)
{
  ...
  8000cd:	e8 61 00 00 00       	call   800133 <sys_env_destroy>
}
  8000d2:	c9                   	leave  
  8000d3:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000da:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8000dd:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8000e0:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
...
sys_cgetc(void)
{
  ...
  800126:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800129:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80012c:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_env_destroy(envid_t envid)
{
  ...
  800136:	83 ec 38             	sub    $0x38,%esp
  800139:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80013c:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80013f:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800159:	7e 28                	jle    800183 <sys_env_destroy+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  80015b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80015f:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800166:	00 
  800167:	c7 44 24 08 ef 12 80 	movl   $0x8012ef,0x8(%esp)
  80016e:	00 
  80016f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800176:	00 
  800177:	c7 04 24 0c 13 80 00 	movl   $0x80130c,(%esp)
  80017e:	e8 d5 02 00 00       	call   800458 <_panic>
...
sys_yield(void)
{
  ...
  8001d4:	b8 0a 00 00 00       	mov    $0xa,%eax
  8001d9:	89 d1                	mov    %edx,%ecx
  8001db:	89 d3                	mov    %edx,%ebx
  8001dd:	89 d7                	mov    %edx,%edi
...
sys_yield(void)
{
  ...
  8001e3:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8001e6:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8001e9:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8001ec:	89 ec                	mov    %ebp,%esp
  8001ee:	5d                   	pop    %ebp
  8001ef:	c3                   	ret    

008001f0 <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800218:	7e 28                	jle    800242 <sys_page_alloc+0x52>
		panic("syscall %d returned %d (> 0)", num, ret);
  80021a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80021e:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  800225:	00 
  800226:	c7 44 24 08 ef 12 80 	movl   $0x8012ef,0x8(%esp)
  80022d:	00 
  80022e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800235:	00 
  800236:	c7 04 24 0c 13 80 00 	movl   $0x80130c,(%esp)
  80023d:	e8 16 02 00 00       	call   800458 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800242:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800245:	8b 75 f8             	mov    -0x8(%ebp),%esi
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800252:	83 ec 38             	sub    $0x38,%esp
  800255:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800258:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80025b:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  80025e:	b8 05 00 00 00       	mov    $0x5,%eax
  800263:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800266:	8b 55 08             	mov    0x8(%ebp),%edx
  800269:	8b 5d 10             	mov    0x10(%ebp),%ebx
  80026c:	8b 7d 14             	mov    0x14(%ebp),%edi
  ...
  800276:	7e 28                	jle    8002a0 <sys_page_map+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800278:	89 44 24 10          	mov    %eax,0x10(%esp)
  80027c:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  800283:	00 
  800284:	c7 44 24 08 ef 12 80 	movl   $0x8012ef,0x8(%esp)
  80028b:	00 
  80028c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800293:	00 
  800294:	c7 04 24 0c 13 80 00 	movl   $0x80130c,(%esp)
  80029b:	e8 b8 01 00 00       	call   800458 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8002a0:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8002a3:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8002a6:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8002a9:	89 ec                	mov    %ebp,%esp
  8002ab:	5d                   	pop    %ebp
  8002ac:	c3                   	ret    

008002ad <sys_page_unmap>:
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002b0:	83 ec 38             	sub    $0x38,%esp
  8002b3:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8002b6:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8002b9:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8002c1:	b8 06 00 00 00       	mov    $0x6,%eax
  ...
  8002d4:	7e 28                	jle    8002fe <sys_page_unmap+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002d6:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002da:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  8002e1:	00 
  8002e2:	c7 44 24 08 ef 12 80 	movl   $0x8012ef,0x8(%esp)
  8002e9:	00 
  8002ea:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002f1:	00 
  8002f2:	c7 04 24 0c 13 80 00 	movl   $0x80130c,(%esp)
  8002f9:	e8 5a 01 00 00       	call   800458 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002fe:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800301:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800304:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800307:	89 ec                	mov    %ebp,%esp
  800309:	5d                   	pop    %ebp
  80030a:	c3                   	ret    

0080030b <sys_env_set_status>:
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80030e:	83 ec 38             	sub    $0x38,%esp
  800311:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800314:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800317:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800332:	7e 28                	jle    80035c <sys_env_set_status+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800334:	89 44 24 10          	mov    %eax,0x10(%esp)
  800338:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  80033f:	00 
  800340:	c7 44 24 08 ef 12 80 	movl   $0x8012ef,0x8(%esp)
  800347:	00 
  800348:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80034f:	00 
  800350:	c7 04 24 0c 13 80 00 	movl   $0x80130c,(%esp)
  800357:	e8 fc 00 00 00       	call   800458 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80036c:	83 ec 38             	sub    $0x38,%esp
  80036f:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800372:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800375:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800390:	7e 28                	jle    8003ba <sys_env_set_pgfault_upcall+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800392:	89 44 24 10          	mov    %eax,0x10(%esp)
  800396:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  80039d:	00 
  80039e:	c7 44 24 08 ef 12 80 	movl   $0x8012ef,0x8(%esp)
  8003a5:	00 
  8003a6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003ad:	00 
  8003ae:	c7 04 24 0c 13 80 00 	movl   $0x80130c,(%esp)
  8003b5:	e8 9e 00 00 00       	call   800458 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003db:	b8 0b 00 00 00       	mov    $0xb,%eax
  8003e0:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  8003e3:	8b 55 08             	mov    0x8(%ebp),%edx
  8003e6:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8003e9:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003ee:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8003f1:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8003f4:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  80042e:	00 
  80042f:	c7 44 24 08 ef 12 80 	movl   $0x8012ef,0x8(%esp)
  800436:	00 
  800437:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80043e:	00 
  80043f:	c7 04 24 0c 13 80 00 	movl   $0x80130c,(%esp)
  800446:	e8 0d 00 00 00       	call   800458 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80045d:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800460:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	if (argv0)
  800463:	a1 08 20 80 00       	mov    0x802008,%eax
  800468:	85 c0                	test   %eax,%eax
  80046a:	74 10                	je     80047c <_panic+0x24>
		cprintf("%s: ", argv0);
  80046c:	89 44 24 04          	mov    %eax,0x4(%esp)
  800470:	c7 04 24 1a 13 80 00 	movl   $0x80131a,(%esp)
  800477:	e8 ef 00 00 00       	call   80056b <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80047c:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800482:	e8 09 fd ff ff       	call   800190 <sys_getenvid>
  ...
  80049d:	c7 04 24 24 13 80 00 	movl   $0x801324,(%esp)
  8004a4:	e8 c2 00 00 00       	call   80056b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8004a9:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8004ad:	8b 45 10             	mov    0x10(%ebp),%eax
  8004b0:	89 04 24             	mov    %eax,(%esp)
  8004b3:	e8 52 00 00 00       	call   80050a <vcprintf>
	cprintf("\n");
  8004b8:	c7 04 24 1f 13 80 00 	movl   $0x80131f,(%esp)
  8004bf:	e8 a7 00 00 00       	call   80056b <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8004c4:	cc                   	int3   
  8004c5:	eb fd                	jmp    8004c4 <_panic+0x6c>
  8004c7:	90                   	nop
...
putch(int ch, struct printbuf *b)
{
  ...
  8004f5:	e8 da fb ff ff       	call   8000d4 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800546:	e8 b7 01 00 00       	call   800702 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80055e:	e8 71 fb ff ff       	call   8000d4 <sys_cputs>
...
cprintf(const char *fmt, ...)
{
  ...
  800583:	c9                   	leave  
  800584:	c3                   	ret    
  800585:	66 90                	xchg   %ax,%ax
  800587:	66 90                	xchg   %ax,%ax
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80066c:	0f be 80 48 13 80 00 	movsbl 0x801348(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800868:	c7 44 24 08 60 13 80 	movl   $0x801360,0x8(%esp)
  80086f:	00 
  ...
  800888:	c7 44 24 08 69 13 80 	movl   $0x801369,0x8(%esp)
  80088f:	00 
  ...
  8008ba:	b8 59 13 80 00       	mov    $0x801359,%eax
