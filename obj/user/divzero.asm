...
libmain(int argc, char **argv)
{
  ...
  800090:	ba 7c 00 c0 ee       	mov    $0xeec0007c,%edx
  800095:	eb 12                	jmp    8000a9 <libmain+0x41>
  800097:	8b 4a 48             	mov    0x48(%edx),%ecx
  80009a:	83 c2 7c             	add    $0x7c,%edx
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80028c:	0f be 80 18 13 80 00 	movsbl 0x801318(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003b7:	ff 24 85 e0 13 80 00 	jmp    *0x8013e0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8004a8:	c7 44 24 08 39 13 80 	movl   $0x801339,0x8(%esp)
  8004af:	00 
  ...
  8004da:	b8 29 13 80 00       	mov    $0x801329,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ca2:	00 
  800ca3:	c7 44 24 08 64 15 80 	movl   $0x801564,0x8(%esp)
  800caa:	00 
  800cab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb2:	00 
  800cb3:	c7 04 24 81 15 80 00 	movl   $0x801581,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d61:	00 
  800d62:	c7 44 24 08 64 15 80 	movl   $0x801564,0x8(%esp)
  800d69:	00 
  800d6a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d71:	00 
  800d72:	c7 04 24 81 15 80 00 	movl   $0x801581,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800dbf:	00 
  800dc0:	c7 44 24 08 64 15 80 	movl   $0x801564,0x8(%esp)
  800dc7:	00 
  800dc8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dcf:	00 
  800dd0:	c7 04 24 81 15 80 00 	movl   $0x801581,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e1d:	00 
  800e1e:	c7 44 24 08 64 15 80 	movl   $0x801564,0x8(%esp)
  800e25:	00 
  800e26:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e2d:	00 
  800e2e:	c7 04 24 81 15 80 00 	movl   $0x801581,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e7b:	00 
  800e7c:	c7 44 24 08 64 15 80 	movl   $0x801564,0x8(%esp)
  800e83:	00 
  800e84:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e8b:	00 
  800e8c:	c7 04 24 81 15 80 00 	movl   $0x801581,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ed9:	00 
  800eda:	c7 44 24 08 64 15 80 	movl   $0x801564,0x8(%esp)
  800ee1:	00 
  800ee2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ee9:	00 
  800eea:	c7 04 24 81 15 80 00 	movl   $0x801581,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800f6a:	00 
  800f6b:	c7 44 24 08 64 15 80 	movl   $0x801564,0x8(%esp)
  800f72:	00 
  800f73:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f7a:	00 
  800f7b:	c7 04 24 81 15 80 00 	movl   $0x801581,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800f9c:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	if (argv0)
  800f9f:	a1 0c 20 80 00       	mov    0x80200c,%eax
  800fa4:	85 c0                	test   %eax,%eax
  800fa6:	74 10                	je     800fb8 <_panic+0x24>
		cprintf("%s: ", argv0);
  800fa8:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fac:	c7 04 24 8f 15 80 00 	movl   $0x80158f,(%esp)
  800fb3:	e8 db f1 ff ff       	call   800193 <cprintf>
  ...
  800fd9:	c7 04 24 94 15 80 00 	movl   $0x801594,(%esp)
  800fe0:	e8 ae f1 ff ff       	call   800193 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800fe5:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800fe9:	8b 45 10             	mov    0x10(%ebp),%eax
  800fec:	89 04 24             	mov    %eax,(%esp)
  800fef:	e8 3e f1 ff ff       	call   800132 <vcprintf>
	cprintf("\n");
  800ff4:	c7 04 24 0c 13 80 00 	movl   $0x80130c,(%esp)
  800ffb:	e8 93 f1 ff ff       	call   800193 <cprintf>
