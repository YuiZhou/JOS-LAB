	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80023c:	0f be 80 31 10 80 00 	movsbl 0x801031(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800367:	ff 24 85 c0 10 80 00 	jmp    *0x8010c0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800458:	c7 44 24 08 52 10 80 	movl   $0x801052,0x8(%esp)
  80045f:	00 
  ...
  80048a:	b8 42 10 80 00       	mov    $0x801042,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c52:	00 
  800c53:	c7 44 24 08 34 12 80 	movl   $0x801234,0x8(%esp)
  800c5a:	00 
  800c5b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c62:	00 
  800c63:	c7 04 24 51 12 80 00 	movl   $0x801251,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800cc4:	c7 04 24 5f 12 80 00 	movl   $0x80125f,(%esp)
  ...
  800cf1:	c7 04 24 68 12 80 00 	movl   $0x801268,(%esp)
  ...
  800d07:	e8 d6 f3 ff ff       	call   8000e2 <vcprintf>
	cprintf("\n");
  800d0c:	c7 04 24 64 12 80 00 	movl   $0x801264,(%esp)
