...
sys_env_destroy(envid_t envid)
{
  ...
  80011e:	00 
  80011f:	c7 44 24 08 fa 0f 80 	movl   $0x800ffa,0x8(%esp)
  800126:	00 
  800127:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80012e:	00 
  80012f:	c7 04 24 17 10 80 00 	movl   $0x801017,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800180:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	if (argv0)
  800183:	a1 08 20 80 00       	mov    0x802008,%eax
  800188:	85 c0                	test   %eax,%eax
  80018a:	74 10                	je     80019c <_panic+0x24>
		cprintf("%s: ", argv0);
  80018c:	89 44 24 04          	mov    %eax,0x4(%esp)
  800190:	c7 04 24 25 10 80 00 	movl   $0x801025,(%esp)
  800197:	e8 ef 00 00 00       	call   80028b <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80019c:	8b 35 00 20 80 00    	mov    0x802000,%esi
  8001a2:	e8 a1 ff ff ff       	call   800148 <sys_getenvid>
  ...
  8001bd:	c7 04 24 2c 10 80 00 	movl   $0x80102c,(%esp)
  8001c4:	e8 c2 00 00 00       	call   80028b <cprintf>
  ...
  8001d3:	e8 52 00 00 00       	call   80022a <vcprintf>
	cprintf("\n");
  8001d8:	c7 04 24 2a 10 80 00 	movl   $0x80102a,(%esp)
  8001df:	e8 a7 00 00 00       	call   80028b <cprintf>
	...
	while (1)
		asm volatile("int3");
  8001e4:	cc                   	int3   
  8001e5:	eb fd                	jmp    8001e4 <_panic+0x6c>
  8001e7:	90                   	nop
...
putch(int ch, struct printbuf *b)
{
  ...
  800215:	e8 72 fe ff ff       	call   80008c <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80027e:	e8 09 fe ff ff       	call   80008c <sys_cputs>
