...
libmain(int argc, char **argv)
{
  ...
  800068:	ba 60 00 c0 ee       	mov    $0xeec00060,%edx
  80006d:	eb 12                	jmp    800081 <libmain+0x41>
  80006f:	8b 4a 48             	mov    0x48(%edx),%ecx
  800072:	83 c2 60             	add    $0x60,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  80015a:	00 
  80015b:	c7 44 24 08 3a 10 80 	movl   $0x80103a,0x8(%esp)
  800162:	00 
  800163:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80016a:	00 
  80016b:	c7 04 24 57 10 80 00 	movl   $0x801057,(%esp)
  800172:	e8 3d 00 00 00       	call   8001b4 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001cc:	c7 04 24 65 10 80 00 	movl   $0x801065,(%esp)
  8001d3:	e8 ef 00 00 00       	call   8002c7 <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8001d8:	8b 35 00 20 80 00    	mov    0x802000,%esi
  8001de:	e8 a1 ff ff ff       	call   800184 <sys_getenvid>
  ...
  8001f1:	89 74 24 08          	mov    %esi,0x8(%esp)
  8001f5:	89 44 24 04          	mov    %eax,0x4(%esp)
  8001f9:	c7 04 24 6c 10 80 00 	movl   $0x80106c,(%esp)
  800200:	e8 c2 00 00 00       	call   8002c7 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800205:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800209:	8b 45 10             	mov    0x10(%ebp),%eax
  80020c:	89 04 24             	mov    %eax,(%esp)
  80020f:	e8 52 00 00 00       	call   800266 <vcprintf>
	cprintf("\n");
  800214:	c7 04 24 6a 10 80 00 	movl   $0x80106a,(%esp)
  80021b:	e8 a7 00 00 00       	call   8002c7 <cprintf>
...
putch(int ch, struct printbuf *b)
{
  ...
  800237:	83 c0 01             	add    $0x1,%eax
  80023a:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  80023c:	3d ff 00 00 00       	cmp    $0xff,%eax
  800241:	75 19                	jne    80025c <putch+0x38>
		sys_cputs(b->buf, b->idx);
  800243:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  80024a:	00 
  80024b:	8d 43 08             	lea    0x8(%ebx),%eax
  80024e:	89 04 24             	mov    %eax,(%esp)
  800251:	e8 72 fe ff ff       	call   8000c8 <sys_cputs>
		b->idx = 0;
  800256:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800269:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  800286:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80028a:	8b 45 08             	mov    0x8(%ebp),%eax
  80028d:	89 44 24 08          	mov    %eax,0x8(%esp)
  800291:	8d 85 f0 fe ff ff    	lea    -0x110(%ebp),%eax
  800297:	89 44 24 04          	mov    %eax,0x4(%esp)
  80029b:	c7 04 24 24 02 80 00 	movl   $0x800224,(%esp)
  8002a2:	e8 bb 01 00 00       	call   800462 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  8002a7:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  8002ad:	89 44 24 04          	mov    %eax,0x4(%esp)
  8002b1:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  8002b7:	89 04 24             	mov    %eax,(%esp)
  8002ba:	e8 09 fe ff ff       	call   8000c8 <sys_cputs>
...
cprintf(const char *fmt, ...)
{
  ...
  8002da:	e8 87 ff ff ff       	call   800266 <vcprintf>
	va_end(ap);
