...
sys_env_destroy(envid_t envid)
{
  ...
  80011a:	00 
  80011b:	c7 44 24 08 fa 0f 80 	movl   $0x800ffa,0x8(%esp)
  800122:	00 
  800123:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80012a:	00 
  80012b:	c7 04 24 17 10 80 00 	movl   $0x801017,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800179:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  80017c:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	if (argv0)
  80017f:	a1 08 20 80 00       	mov    0x802008,%eax
  800184:	85 c0                	test   %eax,%eax
  800186:	74 10                	je     800198 <_panic+0x24>
		cprintf("%s: ", argv0);
  800188:	89 44 24 04          	mov    %eax,0x4(%esp)
  80018c:	c7 04 24 25 10 80 00 	movl   $0x801025,(%esp)
  800193:	e8 ef 00 00 00       	call   800287 <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800198:	8b 35 00 20 80 00    	mov    0x802000,%esi
  80019e:	e8 a1 ff ff ff       	call   800144 <sys_getenvid>
  8001a3:	8b 55 0c             	mov    0xc(%ebp),%edx
  8001a6:	89 54 24 10          	mov    %edx,0x10(%esp)
  8001aa:	8b 55 08             	mov    0x8(%ebp),%edx
  8001ad:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8001b1:	89 74 24 08          	mov    %esi,0x8(%esp)
  8001b5:	89 44 24 04          	mov    %eax,0x4(%esp)
  8001b9:	c7 04 24 2c 10 80 00 	movl   $0x80102c,(%esp)
  8001c0:	e8 c2 00 00 00       	call   800287 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8001c5:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8001c9:	8b 45 10             	mov    0x10(%ebp),%eax
  8001cc:	89 04 24             	mov    %eax,(%esp)
  8001cf:	e8 52 00 00 00       	call   800226 <vcprintf>
	cprintf("\n");
  8001d4:	c7 04 24 2a 10 80 00 	movl   $0x80102a,(%esp)
  8001db:	e8 a7 00 00 00       	call   800287 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8001e0:	cc                   	int3   
  8001e1:	eb fd                	jmp    8001e0 <_panic+0x6c>
  8001e3:	90                   	nop
...
putch(int ch, struct printbuf *b)
{
  ...
  800211:	e8 72 fe ff ff       	call   800088 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80027a:	e8 09 fe ff ff       	call   800088 <sys_cputs>
