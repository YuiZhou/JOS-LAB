	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80027c:	0f be 80 08 13 80 00 	movsbl 0x801308(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003a7:	ff 24 85 c0 13 80 00 	jmp    *0x8013c0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800498:	c7 44 24 08 29 13 80 	movl   $0x801329,0x8(%esp)
  80049f:	00 
  ...
  8004ca:	b8 19 13 80 00       	mov    $0x801319,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c92:	00 
  800c93:	c7 44 24 08 44 15 80 	movl   $0x801544,0x8(%esp)
  800c9a:	00 
  800c9b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca2:	00 
  800ca3:	c7 04 24 61 15 80 00 	movl   $0x801561,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d51:	00 
  800d52:	c7 44 24 08 44 15 80 	movl   $0x801544,0x8(%esp)
  800d59:	00 
  800d5a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d61:	00 
  800d62:	c7 04 24 61 15 80 00 	movl   $0x801561,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800daf:	00 
  800db0:	c7 44 24 08 44 15 80 	movl   $0x801544,0x8(%esp)
  800db7:	00 
  800db8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dbf:	00 
  800dc0:	c7 04 24 61 15 80 00 	movl   $0x801561,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e0d:	00 
  800e0e:	c7 44 24 08 44 15 80 	movl   $0x801544,0x8(%esp)
  800e15:	00 
  800e16:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e1d:	00 
  800e1e:	c7 04 24 61 15 80 00 	movl   $0x801561,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e6b:	00 
  800e6c:	c7 44 24 08 44 15 80 	movl   $0x801544,0x8(%esp)
  800e73:	00 
  800e74:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e7b:	00 
  800e7c:	c7 04 24 61 15 80 00 	movl   $0x801561,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ec9:	00 
  800eca:	c7 44 24 08 44 15 80 	movl   $0x801544,0x8(%esp)
  800ed1:	00 
  800ed2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ed9:	00 
  800eda:	c7 04 24 61 15 80 00 	movl   $0x801561,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800f5a:	00 
  800f5b:	c7 44 24 08 44 15 80 	movl   $0x801544,0x8(%esp)
  800f62:	00 
  800f63:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f6a:	00 
  800f6b:	c7 04 24 61 15 80 00 	movl   $0x801561,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800f9c:	c7 04 24 6f 15 80 00 	movl   $0x80156f,(%esp)
  ...
  800fc9:	c7 04 24 74 15 80 00 	movl   $0x801574,(%esp)
  ...
  800fdf:	e8 3a f1 ff ff       	call   80011e <vcprintf>
	cprintf("\n");
  800fe4:	c7 04 24 fc 12 80 00 	movl   $0x8012fc,(%esp)
