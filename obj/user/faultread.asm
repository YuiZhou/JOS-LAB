	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80027c:	0f be 80 68 10 80 00 	movsbl 0x801068(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003a7:	ff 24 85 f8 10 80 00 	jmp    *0x8010f8(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800498:	c7 44 24 08 89 10 80 	movl   $0x801089,0x8(%esp)
  80049f:	00 
  ...
  8004ca:	b8 79 10 80 00       	mov    $0x801079,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c92:	00 
  800c93:	c7 44 24 08 6c 12 80 	movl   $0x80126c,0x8(%esp)
  800c9a:	00 
  800c9b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca2:	00 
  800ca3:	c7 04 24 89 12 80 00 	movl   $0x801289,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d04:	c7 04 24 97 12 80 00 	movl   $0x801297,(%esp)
  ...
  800d31:	c7 04 24 9c 12 80 00 	movl   $0x80129c,(%esp)
  ...
  800d47:	e8 d2 f3 ff ff       	call   80011e <vcprintf>
	cprintf("\n");
  800d4c:	c7 04 24 5c 10 80 00 	movl   $0x80105c,(%esp)
